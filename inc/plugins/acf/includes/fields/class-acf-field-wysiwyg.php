			...
			<div id="wp-<?= $id; ?>-editor-tools" class="wp-editor-tools hide-if-no-js">
				...
				<?php if( user_can_richedit() && $show_tabs ): ?>
					<div class="wp-editor-tabs">
						<button id="<?= $id; ?>-tmce" class="wp-switch-editor switch-tmce" <?= $button; ?> type="button"><?= __('Visual', 'acf'); ?></button>
						<button id="<?= $id; ?>-html" class="wp-switch-editor switch-html" <?= $button; ?> type="button"><?= _x( 'Text', 'Name for the Text editor tab (formerly HTML)', 'acf' ); ?></button>
					</div>
				<?php endif; ?>
			</div>
