...
<div <?php acf_esc_attr_e($attrs); ?>>
	...
	<div class="title">
		...
		<input class="search" type="text" placeholder="<?php _e("Search for address...",'acf'); ?>" value="<?= esc_attr( $search ); ?>" />
		<i class="acf-loading"></i>
				
	</div>
	
	<div class="canvas" style="<?= esc_attr('height: '.$field['height'].'px'); ?>"></div>
