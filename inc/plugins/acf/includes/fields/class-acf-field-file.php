...
<div <?php acf_esc_attr_e( $div ); ?>>
	...
	<div class="show-if-value file-wrap">
		<div class="file-icon">
			<img data-name="icon" src="<?= esc_url($o['icon']); ?>" alt=""/>
		</div>
		<div class="file-info">
			<p>
				<strong data-name="title"><?= esc_html($o['title']); ?></strong>
			</p>
			<p>
				<strong><?php _e('File name', 'acf'); ?>:</strong>
				<a data-name="filename" href="<?= esc_url($o['url']); ?>" target="_blank"><?= esc_html($o['filename']); ?></a>
			</p>
			<p>
				<strong><?php _e('File size', 'acf'); ?>:</strong>
				<span data-name="filesize"><?= esc_html($o['filesize']); ?></span>
			</p>
		</div>
	...
	<div class="hide-if-value">
		<?php if( $uploader == 'basic' ): ?>
			...
			<?php if( $field['value'] && !is_numeric($field['value']) ): ?>
				<div class="acf-error-message"><p><?= acf_esc_html($field['value']); ?></p></div>
			<?php endif; ?>
