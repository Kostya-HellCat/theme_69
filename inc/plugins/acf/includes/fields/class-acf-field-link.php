...
class acf_field_link extends acf_field {
	...
	*/
	...
	function render_field( $field ){
		...
		/*<textarea id="<?= esc_attr($field['id']); ?>-textarea"><?php
...
<div <?php acf_esc_attr_e($div); ?>>
	...
	<div class="acf-hidden">
		<a class="link-node" href="<?= esc_url($link['url']); ?>" target="<?= esc_attr($link['target']); ?>"><?= esc_html($link['title']); ?></a>
	...
	<div class="link-wrap">
		<span class="link-title"><?= esc_html($link['title']); ?></span>
		<a class="link-url" href="<?= esc_url($link['url']); ?>" target="_blank"><?= esc_html($link['url']); ?></a>
