	...
	<div class="handle">
		<ul class="acf-hl acf-tbody">
			<li class="li-field-order">
				<span class="acf-icon acf-sortable-handle" title="<?php _e('Drag to reorder','acf'); ?>"><?= ($i + 1); ?></span>
			</li>
			<li class="li-field-label">
				<strong>
					<a class="edit-field" title="<?php _e("Edit field",'acf'); ?>" href="#"><?= acf_get_field_label($field, 'admin'); ?></a>
				</strong>
			...
			<li class="li-field-key"> <?= $field['key']; ?></li>
			<li class="li-field-type"> <?= acf_get_field_type_label($field['type']); ?></li>
		</ul>
	</div>
