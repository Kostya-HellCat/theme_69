...
<div class="wrap" id="acf-admin-tools">
	...
	<h1><?php _e('Tools', 'acf'); ?> <?php if( $active ): ?><a class="page-title-action" href="<?= acf_get_admin_tools_url(); ?>"><?php _e('Back to all tools', 'acf'); ?></a><?php endif; ?></h1>
	
	<div class="acf-meta-box-wrap -<?= $class; ?>">
