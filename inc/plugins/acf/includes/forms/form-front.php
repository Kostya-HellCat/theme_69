...
class acf_form_front {
	...
	*/
	...
	function render_form( $args = array() ) {
		...
		// display form
		if( $args['form'] ): ?>
		<form <?= acf_esc_attrs( $args['form_attributes'] ); ?>>
		<?php endif; 
			...
			?>
			<div class="acf-fields acf-form-fields -<?= esc_attr($args['label_placement']); ?>">
				<?= $args['html_before_fields']; ?>
