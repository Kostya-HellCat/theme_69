...
<table class="acf-table">
	...
	<tbody>
		<?php foreach( $value as $i => $row ): 
			...
			?>
			<tr class="acf-row<?php if( $i === 'acfcloneindex' ){ echo ' acf-clone'; } ?>" data-id="<?= $id; ?>">
...
<?php if( $show_add ): ?>
	...
	<div class="acf-actions">
		<a class="acf-button button button-primary" href="#" data-event="add-row"><?= $field['button_label']; ?></a>
	</div>
