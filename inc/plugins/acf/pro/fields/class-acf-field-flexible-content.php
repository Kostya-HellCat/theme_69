...
<div <?php acf_esc_attr_e( $div ); ?>>
	...
	<div class="acf-actions">
		<a class="acf-button button button-primary" href="#" data-name="add-layout"><?= $field['button_label']; ?></a>
	</div>
	...
	<script type="text-html" class="tmpl-popup"><?php 
		?><ul><?php foreach( $layouts as $layout ): 
			...
			?><li><a <?php acf_esc_attr_e( $atts ); ?>><?= $layout['label']; ?></a></li><?php 
...
<div <?= acf_esc_attr($div); ?>>
	...
	<div class="acf-fc-layout-handle" title="<?php _e('Drag to reorder','acf'); ?>" data-name="collapse-layout"><?= $title; ?></div>
