		...
		*/
		...
		<div id="major-publishing-actions">
			...
			<div id="publishing-action">
				...
				<input type="submit" accesskey="p" value="<?= $this->page['update_button']; ?>" class="button button-primary button-large" id="publish" name="publish">
			</div>
