				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							<th></th>
							<td>
								<input type="submit" value="<?= esc_attr( $button ); ?>" class="button button-primary">
							</td>
						</tr>
					</tbody>
				</table>
					...
					<tr>
						...
						<td>
							<?php if( $update_available ): ?>
								...
								<?php if( $active ): ?>
									<a class="button button-primary" href="<?= esc_attr( admin_url('plugins.php?s=Advanced+Custom+Fields+Pro') ); ?>"><?php _e('Update Plugin', 'acf'); ?></a>
								<?php else: ?>
							...
							<?php else: ?>
								...
								<a class="button" href="<?= esc_attr( add_query_arg('force-check', 1) ); ?>"><?php _e('Check Again', 'acf'); ?></a>
							<?php endif; ?>
						</td>
					</tr>
					<?php if( $changelog ): ?>
